(function ($) {
	...
	/* ---------------------------------------------
	 ...
	 --------------------------------------------- */
	function init_popup() {
		if ($(window).width() + boutique_get_scrollbar_width()) {
			if ($('body').hasClass('home')) {
				//Open directly via API
				$.magnificPopup.open({
					items: {
						src: '<div class="white-popup"><div class="kt-popup-newsletter"><div class="popup-title"><img src="./images/welcome.png"/></div></div></div><br>', //can be a HTML string, jQuery object, or CSS selector
						type: 'inline'
